...
class Capture_Request(metaclass=Metaclass_Capture_Request):
    ...
    def cam(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'cam' field must be an integer in [-2147483648, 2147483647]"
        self._cam = value
    ...
    def rec(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'rec' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'rec' field must be an integer in [-2147483648, 2147483647]"
        self._rec = value
...
class Metaclass_Capture(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from camera_app_msgs.srv import _capture
...
class Capture(metaclass=Metaclass_Capture):
    from camera_app_msgs.srv._capture import Capture_Request as Request
    from camera_app_msgs.srv._capture import Capture_Response as Response
